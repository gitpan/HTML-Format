# This Makefile is for the HTML::Format extension to perl.
#
...
#     NAME => q[HTML::Format]
#     VERSION_FROM => q[lib/HTML/Format.pm]
...
PARENT_NAME = HTML
DLBASE = $(BASEEXT)
VERSION_FROM = lib/HTML/Format.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/HTML/Format.pm

PM_TO_BLIB = lib/HTML/Format.pm \
	blib/lib/HTML/Format.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/HTML/Format.pm $(INST_MAN3DIR)/HTML::Format.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         HTML-Format' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.1' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/HTML/Format.pm' >> META_new.yml
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/HTML/Format.pm blib/lib/HTML/Format.pm 
